# Chương 50: Đại dự án tốt nghiệp: Xây dựng Động cơ Xử lý Đơn hàng Phân tán (Capstone Project: Distributed Order Processing Engine)
...
2. **Bài tập 2 (Xây dựng Tiến trình Dọn dẹp và Nén Nhật ký WAL - Log Compaction)**:  
   Sau khi hệ thống ghi nhận 10,000 sự kiện, tệp `orders.wal` sẽ phình to. Hãy viết hàm `compact_wal_log(&self)` chỉ giữ lại trạng thái cuối cùng mới nhất của từng đơn hàng và ghi sang tệp mới gọn gàng, giải phóng dung lượng đĩa tương tự như kiến trúc Bitcask đã học ở Chương 32.
