# Chương 22: Lưu trữ vùng nhớ liền kề: Mảng cố định, Vector động và Lát cắt (Contiguous Memory: Arrays, Vectors & Slices)
...
> Nếu bạn biết trước mình cần nạp 10.000 phần tử, việc gọi `Vec::new()` rồi `push` liên tục sẽ khiến vector phải xin cấp phát và sao chép dữ liệu khoảng 14 lần (1 -> 2 -> 4 -> 8 -> ... -> 16.384). Thay vào đó, khởi tạo ngay `Vec::with_capacity(10_000)` sẽ cấp phát đúng 1 lần duy nhất trên Heap, tăng tốc chương trình lên gấp nhiều lần!
